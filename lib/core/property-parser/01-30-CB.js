...
* - EPC              : CB : Self-cleaning function setting
* ---------------------------------------------------------------- */
'use strict';
...
EchonetLitePropertyParser.prototype.parse = function(buf) {
	...
	var offset = 0;
	var message = {};
	['OZN', 'DRY'].forEach((bse_key) => {
		var msg_key = (bse_key === 'OZN') ? 'ozone' : 'drying';
...
EchonetLitePropertyParser.prototype.create = function(data) {
	...
	var buf_list = [];
	['ozone', 'drying'].forEach(function(k) {
