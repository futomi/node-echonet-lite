...
* - EPC              : B9 : Illuminance level setting for night lighting
...
var EchonetLitePropertyParser = function() {
	...
	this.descs = {
		'en': {
			'LVL': {
				'field': 'Illuminance level setting for night lighting',
				'values': {}
			}
		},
		'ja': {
			'LVL': {
				'field': '常夜灯モード時照度レベル設定',
				'values': {}
			}
		}
	}
