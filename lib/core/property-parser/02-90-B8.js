...
* - EPC              : B8 : Illuminance level step setting for main lighting
* ---------------------------------------------------------------- */
'use strict';
...
var EchonetLitePropertyParser = function() {
	...
	this.descs = {
		'en': {
			'STP': {
				'field': 'Illuminance level step setting for main lighting',
				'values': {}
			}
		},
		'ja': {
			'STP': {
				'field': '通常灯モード時照度レベル段数設定',
				'values': {}
			}
		}
	}
