...
* - EPC              : BC : Light color level step setting for main lighting 
* ---------------------------------------------------------------- */
'use strict';
...
var EchonetLitePropertyParser = function() {
	...
	this.descs = {
		'en': {
			'STP': {
				'field': 'Light color level step setting for main lighting',
				'values': {}
			}
		},
		'ja': {
			'STP': {
				'field': '通常灯モード時光色レベル段数設定',
				'values': {}
			}
		}
	}
