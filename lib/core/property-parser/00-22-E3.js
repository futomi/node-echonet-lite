...
* - EPC              : E3 : Large-capacity sensor instantaneous electric energy
* ---------------------------------------------------------------- */
'use strict';
...
var EchonetLitePropertyParser = function() {
	...
	this.descs = {
		'en': {
			'ENG': {
				'field': 'Large-capacity sensor instantaneous electric energy',
				'values': {}
			}
		},
		'ja': {
			'ENG': {
				'field': '大容量センサ瞬時電力値計測値',
				'values': {}
			}
		}
	}
...
EchonetLitePropertyParser.prototype.parse = function(buf) {
	...
	var eng_key = 'ENG';
	var eng_value = eng_buf.readInt16BE(0); // 0.1kW 
	var eng = {
		'key'   : eng_key,
