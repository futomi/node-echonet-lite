...
* - EPC              : BE : Measured outdoor air temperature
* ---------------------------------------------------------------- */
'use strict';
...
var EchonetLitePropertyParser = function() {
	...
	this.descs = {
		'en': {
			'TMP': {
				'field': 'Measured outdoor air temperature',
				'values': {}
			}
		},
		'ja': {
...
EchonetLitePropertyParser.prototype.create = function(data) {
	...
	if(typeof(temperature) === 'number') {
		if(temperature < -127 || temperature > 125 || temperature % 1 > 0) {
