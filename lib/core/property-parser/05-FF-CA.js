...
* - EPC              : CA : Registered information renewal date of the device to be controlled
* ---------------------------------------------------------------- */
'use strict';
...
var EchonetLitePropertyParser = function() {
	...
	this.descs = {
		'en': {
			'PRD': {
				'field': 'Registered information renewal date of the device to be controlled',
				'values': {}
			}
		},
		'ja': {
			'PRD': {
				'field': '管理対象機器登録情報更新年月日',
				'values': {}
			}
		}
	}
...
EchonetLitePropertyParser.prototype.parse = function(buf) {
	...
	// Registered information renewal date of the device to be controlled
