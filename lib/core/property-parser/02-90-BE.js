...
* - EPC              : BC : Light color level step setting for night lighting
* ---------------------------------------------------------------- */
'use strict';
...
var EchonetLitePropertyParser = function() {
	...
	this.descs = {
		'en': {
			'STP': {
				'field': 'Light color level step setting for night lighting',
				'values': {}
			}
		},
		'ja': {
			'STP': {
				'field': '常夜灯モード時光色レベル段数設定',
				'values': {}
			}
		}
	}
