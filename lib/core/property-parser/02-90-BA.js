...
* - EPC              : BA : Illuminance level step setting for night lighting
* ---------------------------------------------------------------- */
'use strict';
...
var EchonetLitePropertyParser = function() {
	...
	this.descs = {
		'en': {
			'STP': {
				'field': 'Illuminance level step setting for night lighting',
				'values': {}
			}
		},
		'ja': {
			'STP': {
				'field': '常夜灯モード時照度レベル段数設定',
				'values': {}
			}
		}
	}
